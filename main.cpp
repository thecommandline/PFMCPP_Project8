...
int main()
{
    ...
    motorcycles.emplace_back("Leonardo");
    motorcycles.emplace_back("Michelangelo");
    motorcycles.emplace_back("Donatello");
    motorcycles.emplace_back("Raphael");
    
    trucks.reserve(2);
    trucks.emplace_back("Knuth");
    trucks.emplace_back("Schneier");
